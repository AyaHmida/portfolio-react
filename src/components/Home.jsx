...
const Portfolio = () => {
  ...
  const phrases = useMemo(
    () => ["IT Specialist", "Developer", "Researcher"],
    []
  );
    ...
    <div>
      ...
      <div className="pt-0">
        <main className="flex flex-col items-center justify-center min-h-screen text-center">
          <h1 className="text-5xl font-bold">Dev. Aya Ben Hmida</h1>
          ...
          <div className="flex mt-8 space-x-6">
            <a
              href="https://www.linkedin.com/in/ben-hmida-aya-b405aa256/"
              target="_blank"
            ...
            <a
              href="https://github.com/AyaHmida"
              target="_blank"
              rel="noopener noreferrer"
